...
raw_dataset_output_folder = os.path.join(output_folder, "raw_dataset")
...
join_dataset_and_autotags(yfcc_dataset_path, yfcc_autotags_path, oiv_folder, raw_dataset_output_folder)
print("Build raw subsets")
joined_to_subsets(oiv_folder, raw_dataset_output_folder, output_folder)
